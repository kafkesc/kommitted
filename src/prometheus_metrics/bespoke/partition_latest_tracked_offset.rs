...
const NAME: &str = formatcp!("{NAMESPACE}_kafka_partition_latest_tracked_offset");
const HELP: &str =
    formatcp!("{HEADER_HELP} {NAME} Latest offset tracked to estimate the lag of consumers of the topic partition.");
