...
const HELP: &str = formatcp!("{HEADER_HELP} {NAME} Latest offset available to consumers of the topic partition.");
...
pub(crate) fn append_metric(cluster_id: &str, topic: &str, partition: u32, offset: u64, res: &mut Vec<String>) {
    res.push(format!(
        "{NAME}\
        {{\
